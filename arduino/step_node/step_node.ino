 ...
 *
 * Arduino IDE: open THIS FOLDER (arduino/step_node/) so step_node.ino compiles.
 * If you copy the sketch, copy the whole folder — fusion code is inside the .ino.
 *
...
#include <math.h>
#include <string.h>
// --- Madgwick fusion (inlined; was imu_fusion.h) ---
/*
